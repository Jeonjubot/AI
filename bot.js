...
async function handleSend() {
  ...
  if (next) {
    if (["END", "END1", "END2", "고장1", "고장2", "철거1", "철거2", "설치1", "설치2"].includes(next.다음ID)) {
      showRating();
    } else {
...
if (nextId === "고장1") {
  window.location.href = `sms:01000000000?body=${encodeURIComponent("댁내형 중계기 고장 문의입니다.")}`;
} else if (nextId === "고장2") {
  window.location.href = `sms:01000000000?body=${encodeURIComponent("기가아토 고장 문의입니다.")}`;
} else if (nextId === "설치1") {
  window.location.href = `sms:01000000000?body=${encodeURIComponent("댁내형중계기 설치 문의입니다.")}`;
} else if (nextId === "설치2") {
  window.location.href = `sms:01000000000?body=${encodeURIComponent("기가아토 설치 문의입니다.")}`;
} else if (nextId === "철거1") {
  ...
  window.location.href = `sms:01000000000?body=${encodeURIComponent("상담 문의드립니다.")}`;
} else if (nextId === "END1") {
