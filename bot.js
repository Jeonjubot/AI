...
if (nextId === "고장1") {
  window.location.href = `sms:01096186496?body=${encodeURIComponent("댁내형 중계기 고장 문의입니다.")}`;
} else if (nextId === "고장2") {
  window.location.href = `sms:01096186496?body=${encodeURIComponent("통화품질 불량으로 장비설치 필요\nKT 인터넷 사용\n기가아토 설치 가능")}`;
} else if (nextId === "설치1") {
  window.location.href = `sms:01096186496?body=${encodeURIComponent("통화품질 불량으로 장비설치 필요\nKT 인터넷 미사용\n댁내형 청공 동의\n댁내형 설치 가능")}`;
} else if (nextId === "설치2") {
  window.location.href = `sms:01096186496?body=${encodeURIComponent("기가아토 설치 문의입니다.")}`;
} else if (nextId === "철거1") {
  window.location.href = `sms:01096186496?body=${encodeURIComponent("철거\n기가아토 철거요청\n방문 철거요청")}`;
} else if (nextId === "철거2") {
  window.location.href = `sms:01096186496?body=${encodeURIComponent("철거\n기가아토 철거요청\n비대면 철거요청")}`;
} else if (nextId === "디버그") {
  window.location.href = "tel:*123456#";
} else if (nextId === "END2") {
  window.location.href = `sms:01096186496?body=${encodeURIComponent("긴급상담\n상담 문의드립니다.")}`;
} else if (nextId === "END1") {
  window.location.href = "tel:01096186496";
}
