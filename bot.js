...
if (nextId === "고장1") {
  ...
  window.location.href = `sms:01093698758?body=${encodeURIComponent("통화품질 불량으로 장비설치 필요<br>KT 인터넷 사용<br>기가아토 설치 가능")}`;
} else if (nextId === "설치1") {
  window.location.href = `sms:01093698758?body=${encodeURIComponent("통화품질 불량으로 장비설치 필요<br>KT 인터넷 미사용<br>댁내형 청공 동의<br>댁내형 설치 가능")}`;
} else if (nextId === "설치2") {
  window.location.href = `sms:01093698758?body=${encodeURIComponent("기가아토 설치 문의입니다.")}`;
} else if (nextId === "철거1") {
  window.location.href = `sms:01093698758?body=${encodeURIComponent("철거<br>기가아토 철거요청<br>방문 철거요청")}`;
} else if (nextId === "철거2") {
  window.location.href = `sms:01093698758?body=${encodeURIComponent("철거<br>기가아토 철거요청<br>비대면 철거요청")}`;
} else if (nextId === "디버그") {
